const physicalComponents = [
  {
    ...
    role: "Tạo ra điện năng từ nhiệt điện, thủy điện, gió và mặt trời.",
  ...
  },
  {
    ...
    role: "Truyền tải điện năng đi xa ở điện áp cao và kết nối vùng nguồn với phụ tải.",
  ...
  },
  {
    ...
    role: "Biến đổi cấp điện áp, đóng cắt, bảo vệ, đo lường và điều khiển.",
  ...
  },
  {
    ...
    role: "Đưa điện đến khu vực tiêu thụ cuối qua lưới trung áp và hạ áp.",
  ...
  },
  {
    ...
    role: "Đại diện nhu cầu tiêu thụ điện của công nghiệp, tòa nhà, hộ dân và trạm sạc.",
...
const pipelineModules = [
  ...
  },
  {
    ...
    icon: "FC",
    name: "Forecasting",
    question: "Phụ tải và nguồn tái tạo sẽ thay đổi thế nào?",
  ...
  },
  {
    ...
    question: "Nếu mất một phần tử, hệ thống còn an toàn không?",
  ...
  },
  {
    ...
    icon: "OP",
    name: "OPF / Dispatch",
    question: "Vận hành thế nào để tối ưu chi phí và an toàn?",
  ...
  },
  {
    ...
    icon: "EM",
    name: "EMT / Stability",
    question: "Sau nhiễu loạn, hệ thống có ổn định không?",
